        ...
        <div class="container d-flex justify-content-center">
            <div class="card border-secondary">
                <div class="card-body ">
                    ...
                    <form action="UsuarioServlet"  method="post"  class="form-group container" name="AgregarForm">
                        ...
                        <input  class="form-control mt-3 " type="text" name="pass" placeholder="Contraseña">
                        
                        <div id="btn_group">   
                            <button id="btn1" class="btn btn-primary ">Agregar</button>
                            <% if (usuario == null) {
                            %>
                            <a type="button"  class="btn btn-primary " id="btn1" href="index.jsp">Cerrar</a>
