...
<html>
    ...
    <body id="fondo">
        ...
        <div class="container justify-content-center">
            <h2 class="text-center mb-4">Modificación de Clientes</h2>
            <table id="taleUsuarios" class="table table-striped table-responsive-md">
                <thead class="table-light">
                    <tr>
                        <th scope="col" style="padding-left: 30px">Cliente</th>
                        <th scope="col">Dni</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <%
                                ...
                                int puntos = cli.getTarjeta().getPuntos();
                            %>

                            <td id="<%=id%>" class="col-md-2" style="color:white; padding-left: 30px"><%=nombre%></td>
                            <td id="<%=id%>" class="col-md-2" style="color:white;"><%=dni%></td>
                            <td id="<%=id%>" class="col-md-2" style="color:white;"><%=puntos%></td>
                            <td class="col-md-2">
                                <a class="btn btn-primary " href="ClienteServlet?action=editarForm&idC=<%=id%>">Editar</a>
                                <a class="btn btn-danger" href="ClienteServlet?action=borrar&idC=<%=id%>">Borrar</a>                          
