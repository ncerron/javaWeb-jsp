        ...
        <div class="container d-flex justify-content-center">
            <div class="card border-secondary">
                <div class="card-body ">
                    ...
                    <form action="ClienteServlet"  method="post"  class="form-group container" name="AgregarForm">
                        ...
                        <input  class="form-control mt-3 " type="text" name="tarjeta" placeholder="Tarjeta">
                        <input  class="form-control mt-3 " type="text" name="puntos" placeholder="Puntos">
                        <div id="btn_group">   
